...
var eBookData = {
	...
	tableList : [ /** 목차 */
		...
		{index:"12",label:"人site 테이블",url:"",child:"0",id:"8",parent:"2"},
		{index:"20",label:"터에서 치르다1",url:"",child:"0",id:"9",parent:"2"},
		{index:"34",label:"터에서 치르다2",url:"",child:"0",id:"18",parent:"2"},
		{index:"40",label:"Hybrid",url:"",child:"1",id:"3",parent:"0"},
		{index:"40",label:"I'll Land, 글로벌",url:"",child:"0",id:"10",parent:"3"},
		{index:"46",label:"Unique",url:"",child:"2",id:"4",parent:"0"},
		{index:"46",label:"JDC 컬렉션",url:"",child:"0",id:"12",parent:"4"},
		{index:"50",label:"함께하는 JDC",url:"",child:"0",id:"20",parent:"4"},
		{index:"58",label:"Multiplay",url:"",child:"1",id:"5",parent:"0"},
		{index:"58",label:"시민과 Thumb타기",url:"",child:"0",id:"14",parent:"5"},
		{index:"64",label:"Beyond",url:"",child:"2",id:"6",parent:"0"},
		{index:"64",label:"동반성장 리포트",url:"",child:"0",id:"16",parent:"6"},
		{index:"68",label:"모다들엉 마당",url:"",child:"0",id:"18",parent:"6"}],
...
[22,{type:"youtube", id:"Youtube_37", name:"noname", visible:"true", x:"0", y:"0", width:"825", height:"467", youtubeURL:"https://youtu.be/3OQfTlYMZ5I?si=t47nKO1lRi5ATafl"}
],
...
[44,{type:"image", id:"Image_177", name:"noname", visible:"true", x:"82", y:"318", width:"660", height:"872", opacity:"100", normalImage:"1767320373912.gif", rolloverImage:"", link:""}
],
[45,{type:"image", id:"Image_178", name:"noname", visible:"true", x:"88", y:"318", width:"642", height:"843", opacity:"100", normalImage:"1767320495443.gif", rolloverImage:"", link:""}
],
...
[52,{type:"image", id:"Image_179", name:"noname", visible:"true", x:"43", y:"302", width:"749", height:"841", opacity:"100", normalImage:"1767320668803.gif", rolloverImage:"", link:""}
],
[53,{type:"image", id:"Image_180", name:"noname", visible:"true", x:"53", y:"303", width:"737", height:"859", opacity:"100", normalImage:"1767320710140.gif", rolloverImage:"", link:""}
],
...
[63,{type:"image", id:"Image_181", name:"noname", visible:"true", x:"40", y:"148", width:"741", height:"1028", opacity:"100", normalImage:"1767320949772.gif", rolloverImage:"", link:""}
],
[70,{type:"image", id:"Image_159", name:"noname", visible:"true", x:"537", y:"145", width:"191", height:"79", opacity:"100", normalImage:"1764655817712.png", rolloverImage:"", link:"address|_blank|https://www.jdcenter.com/ebook/202512/index.html"},
...
[72,{type:"image", id:"Image_162", name:"noname", visible:"true", x:"593", y:"519", width:"138", height:"92", opacity:"100", normalImage:"1764655817712.png", rolloverImage:"", link:"address|_blank|https://naver.me/GsouCQUI"},
{type:"image", id:"Image_174", name:"noname", visible:"true", x:"591", y:"213", width:"138", height:"92", opacity:"100", normalImage:"1764655817712.png", rolloverImage:"", link:"address|_blank|https://naver.me/5gY9jWYj"}
],
